	  ...
	  $( "#confirmation" ).dialog({
	    ...
	    buttons: {
	        "Oui": function() {
	            ...
	            var chemin = tabUrl[0]+'public/admission/supprimer';
	            $.ajax({
	                type: 'POST',
	                url: chemin ,
	                ...
	                success: function(data) {
	                	     ...
	                	     $("#"+id_patient).parent().parent().parent().fadeOut(function(){
	                	    	 vart = tabUrl[0]+'public/admission/liste-patient';
    ...
    function visualiser(id){
    	vart=tabUrl[0]+'public/admission/info-patient/id_patient/'+id;
        $(location).attr("href",vart);
    }
    
    function modifier(id){
    	vart=tabUrl[0]+'public/admission/modifier/id_patient/'+id;
        $(location).attr("href",vart);
    }
