	  ...
	  $( "#confirmation" ).dialog({
	    ...
	    buttons: {
	        "Oui": function() {
	            ...
	            var chemin = tabUrl[0]+'public/planification/supprimer';
	            $.ajax({
	                type: 'POST',
	                url: chemin ,
	                ...
	                success: function(data) {
	                	     ...
	                	     $("#"+id_patient).parent().parent().parent().fadeOut(function(){
	                	    	 vart = tabUrl[0]+'public/planification/liste-des-planifications';
   ...
   function visualiser(id){
    	vart=tabUrl[0]+'public/planification/info-planification/id_patient/'+id;
       $(location).attr("href",vart);
    }
