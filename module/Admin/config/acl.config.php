...
return array(
    ...
    // gynecologie controller
    						...
    						'Maternite\Controller\Accouchement' => array(
    								...
    								'liste-destinataires'=>array('gynecologue','stagiaire','infirmier','sage_femme'),
    								'liste-destinataires-ajax'=>array('gynecologue','stagiaire','infirmier','sage_femme'),
    								'envoi-sms-pour-rv' => array('guest', 'infirmier','stagiaire', 'gynecologue','sage_femme'),
    								'historique-des-destinataires'=>array('gynecologue','stagiaire','infirmier','sage_femme'),
    								'historique-des-destinataires-ajax'=>array('gynecologue','stagiaire','infirmier','sage_femme'),
    								'info-destinataire'=>array('gynecologue','stagiaire','infirmier','sage_femme'),
